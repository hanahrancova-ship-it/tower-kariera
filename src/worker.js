...
async function handleGetData(request, env, session) {
  const keys = ['imports', 'warnings', 'cesta', 'pozicie', 'bruto', 'poznamky', 'ev_poznamky', 'pb_dismissed', 'prispevky'];
  const result = {};
  for (const k of keys) {
...
async function handleSaveData(request, env, session) {
  ...
  const allowedKeys = ['imports', 'warnings', 'cesta', 'pozicie', 'bruto', 'poznamky', 'ev_poznamky', 'pb_dismissed', 'prispevky'];
